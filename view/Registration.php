...
<body>
    <div class="main">
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" name="registerForm" method="POST" onsubmit="return isvalid()">
        ...
        <fieldset class="field">
            ...
            <fieldset class="field">
                ...
                <br>
                <textarea name="parmanentAddress" id="parmanentAddress" cols="40" rows="3" ><?php echo $parmanentAddress;?></textarea>
                <span id="parmanentAddressErr" style="color : red;"><?php echo $parmanentAddressErr; ?></span>
                <br><br>
                ...
                <input type="email" name="email" id="email" placeholder="abcd@gmail.com"  value="<?php echo $email; ?>" ><span id="emailErr" style="color : red;"><?php echo $emailErr; ?></span>
                <br><br>
